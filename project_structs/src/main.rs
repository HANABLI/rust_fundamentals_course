...
fn main() {
    ...
    println!(" The Person created is:\n\r First Name: {}\n\r Last Name: {}\n\r Age: {:?}\n\r", hatem.first_name, hatem.last_name, hatem.age);
    let mut new_user = User::new(
        String::from("Hatem"),
        String::from("hatem@exemple.com"),
        String::from("https:://hatem"),
    );
    println!(" The created user's name is: {} with infos:\n\r email: {}\n\r uri: {}", new_user.name, new_user.email, new_user.uri);
    ...
    println!(" Point cordinates: {}, {}, {}", new_point.0, new_point.1, new_point.2);
}
